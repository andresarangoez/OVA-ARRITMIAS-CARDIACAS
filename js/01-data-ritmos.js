...
// --- SISTEMA ANTIGUO (Se mantiene como FALLBACK DE SEGURIDAD) ---
    ...
    const RITMOS_DB = {
        ...
        'mp_ventricular': { cat: 2, onda: ondas_base.ancha, pulso: true, desf: false, med: "Observación", hmd: {fc: 70, sis: 115, dia: 75, fr: 16, temp: 36.5} },
        'mp_fallo_est': { cat: 2, onda: ondas_base.lenta, pulso: true, desf: false, med: "Ajuste Dispositivo", hmd: {fc: 35, sis: 80, dia: 50, fr: 14, temp: 36.2} },
        ...
        'tsvp': { cat: 3, onda: ondas_base.normal, pulso: true, desf: false, med: "Adenosina 6mg", hmd: {fc: 170, sis: 95, dia: 60, fr: 24, temp: 37.0} },
        ...
        'tvsp': { cat: 5, onda: ondas_base.ancha, pulso: false, desf: true, med: "Adrenalina / Amiodarona", hmd: {fc: 0, sis: 0, dia: 0, fr: 0, temp: 35.5} },
